...
final class DatedIdentifierTests: XCTestCase {
    func testRawValue() {
        XCTAssertEqual(DatedIdentifier<Self>(date: Date(timeIntervalSince1970: 0), token: 0), DatedIdentifier<Self>(rawValue: "1970-01-01 00-00-00 0000000000000000"))
        XCTAssertEqual(DatedIdentifier<Self>(rawValue: "1970-01-01 00-00-00 0000000000000000").rawValue, "1970-01-01 00-00-00 0000000000000000")
        
        XCTAssertEqual(DatedIdentifier<Self>(date: Date(timeIntervalSince1970: 0), token: 0x0123456789abcdef), DatedIdentifier<Self>(rawValue: "1970-01-01 00-00-00 0123456789ABCDEF"))
        XCTAssertEqual(DatedIdentifier<Self>(rawValue: "1970-01-01 00-00-00 0123456789ABCDEF").rawValue, "1970-01-01 00-00-00 0123456789ABCDEF")
